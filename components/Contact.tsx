...
const Contact: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    emailjs
      .sendForm(
        'service_7y2ctd2',   // <-- replace with your EmailJS Service ID
        'template_g01u6g6',  // <-- replace with your EmailJS Template ID
        formRef.current,
        "-D5wuBR_Z-iDDdzIF"
      )
      .then(
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <div>
                ...
                <p className="text-white font-medium group-hover:text-[#E59173] transition-colors">
                  {PERSONAL_INFO.email}
                </p>
              </div>
            </a>
            ...
            <a href={PERSONAL_INFO.linkedin} target="_blank" rel="noopener noreferrer" className="flex items-center gap-6 group">
              <div className="w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center text-[#E59173] group-hover:bg-[#E59173]/10 transition-all overflow-visible">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
